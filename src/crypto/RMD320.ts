...
class RMD320 implements IHashAlgorithm {
    ...
    private _digest: Uint32Array = allocUint32Array([0x67452301, 0xEFCDAB89, 0x98BADCFE, 0x10325476, 0xC3D2E1F0, 0x76543210, 0xFEDCBA98, 0x89ABCDEF, 0x01234567, 0x3C2D1E0F]);
    ...
    public final(): Uint8Array {
        ...
        const digest: Uint8Array = encodeUint32(this._digest, allocUint8Array(40), true, 0, 10, 0, 40);
        this.reset();
