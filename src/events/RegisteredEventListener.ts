...
class RegisteredEventListener {
    ...
    constructor(listener: IEventListener, capture: boolean = false, context: any = null, once: boolean = false, priority: number = 0) {
    ...
    public handleEvent(event: Event): void {
        if (typeof this._listener === "function") {
            return this._listener.call(this._context !== void 0 && this._context !== null ? this._context : event.currentTarget, event);
        }
