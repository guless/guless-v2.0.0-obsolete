...
class SingletonElementFactory {
    private static readonly __REGISTRY__: Record<string, HTMLElement> = Object.create(null);
    ...
    public static create(tagName: string): HTMLElement {
        ...
        return SingletonElementFactory.__REGISTRY__[tagName];
    }
    ...
    public static register(tagName: string, element: HTMLElement): void {
        SingletonElementFactory.__REGISTRY__[tagName] = element;
    }
}
