...
function detectSystemIsLittleEndian(): boolean {
...
export const IS_LITTLE_ENDIAN: boolean = detectSystemIsLittleEndian();
export const IS_BIG_ENDIAN: boolean = !IS_LITTLE_ENDIAN;
