...
export const SUPPORTED_TYPED_ARRAY: boolean = (typeof ArrayBuffer === "function" && typeof Uint8Array === "function");
export const SUPPORTED_MATH_FROUND: boolean = (typeof Math.fround === "function");
